...
![Pasted image 20260326163557.png](images/Pasted%20image%2020260326163557.png)
...
![Pasted image 20260326164520.png](images/Pasted%20image%2020260326164520.png)
...
![Pasted image 20260326164649.png](images/Pasted%20image%2020260326164649.png)
**Oxi hoá**
1: Ngoài không khí có phản ứng với $O_2$ => $SiO_2$
![Pasted image 20260326164759.png](images/Pasted%20image%2020260326164759.png)

2: Lò, tốc độ nhanh hơn.
![Pasted image 20260326164812.png](images/Pasted%20image%2020260326164812.png)
...
![Pasted image 20260326164935.png](images/Pasted%20image%2020260326164935.png)
Vancuum chunk
Quay + nhỏ dung dịch quang trở
Do lực li tâm => lớp mỏng và đồng đều
![Pasted image 20260326165012.png](images/Pasted%20image%2020260326165012.png)
...
![Pasted image 20260326165357.png](images/Pasted%20image%2020260326165357.png)
![Pasted image 20260326165405.png](images/Pasted%20image%2020260326165405.png)
...
Có 2 loại quang trở:
![Pasted image 20260326171808.png](images/Pasted%20image%2020260326171808.png)
...
![Pasted image 20260326171954.png](images/Pasted%20image%2020260326171954.png)

**Development**: là quá trình rửa trôi những phần PR không cần thiết.

![Pasted image 20260326172046.png](images/Pasted%20image%2020260326172046.png)
...
![Pasted image 20260326182158.png](images/Pasted%20image%2020260326182158.png)
...
![Pasted image 20260326182930.png](images/Pasted%20image%2020260326182930.png)
...
![Pasted image 20260326183156.png](images/Pasted%20image%2020260326183156.png)
![Pasted image 20260326183144.png](images/Pasted%20image%2020260326183144.png)
...
![Pasted image 20260326183848.png](images/Pasted%20image%2020260326183848.png)


**Dry-etching**

Để giải quyết triệu để lõi lẹm chân của khắc ướt và đáp ứng yêu cầu tạo linh kiện ở quy mô siêu nhỏ (nanascale), công nghiệp bán dẫn bắt buộc phải sử dụng phương pháp **dry etching**, phổ biến nhất là khắc ion phản ứng (reactive ion etching - RIE)

**Bản chất quá trình**: thay vì dùng chất lỏng, hệ thống bơm khí phản ứng ($CF_4 , SF_6 , Cl_2$) vào **buồng chân không** đánh lửa RF (radio frequency - tần số vô tuyến, thường là 13,56 MHz) để tạo trạng thái **Plasma**. Hỗn hợp Plasma này chứa các ion mang điện dương và các gốc tự do (raddicals) hoạt tính cao.

![](images/Pasted%20image%2020260327224513.png)

Quá trình ăn mòng diễn ra là sự kết hợp của 2 cơ chế:

**Hoá học**: các gốc tự do khuếch tán xuống bề mặt, phản ứng với lớp vật liệu (như Si hoặc $SiO_2$) tạo thành các chất khí dễ bay hơi rồi bị bươm chân không hút ra ngoài.
**Vật lý**: Dưới tác dụng của điện trường định hướng, các ion dương bị gia tốc mạnh, lao thẳng xuống như đạn pháo để cày phá, bẽ gãy liên kết tinh thể của vật liệu lộ ra.
# **[[8.  Doping - pha tạp]]**
